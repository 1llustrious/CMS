...
class Base
{
    ...
    // const NOTIFY = 'http://www.hcxyst.cn/shop/index.php/index/Flow/wxPaySuccess';   
    ...
    public function __construct()
    {
        ...
        $this->data['MCHID'] = $data['MCHID'];
        $this->data['SECRET'] = $data['SECRET'];
        $this->data['UOURL'] = $data['UOURL'];
    ...
    public function getSign($arr)
    {
        ...
        ksort($arr);
        //组装字符
        $str = $this->arrToUrl($arr) . '&key=' . $this->data['KEY'];
        //使用md5 加密 转换成大写 
    ...
    public function unifiedorder($params)
    {
        ...
        //发送数据到统一下单API地址
        $data = $this->postStr($this->data['UOURL'], $xml);
